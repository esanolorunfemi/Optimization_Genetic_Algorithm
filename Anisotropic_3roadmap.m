...
for m = 1:length(yy) 
   ...
   %15mm zero degrees
      ...
      DY21(k) = sqrt((yy(m)-49.75).^2+(zz(j)-9.75).^2);
      DY31(k) = sqrt((yy(m)-50.25).^2+(zz(j)-9.75).^2);
      DY41(k) = sqrt((yy(m)-49.75).^2+(zz(j)-10.25).^2);
      DY51(k) = sqrt((yy(m)-50.25).^2+(zz(j)-10.25).^2);
      ...
      DY22(k) = sqrt((yy(m)-49.75).^2+(zz(j)-4.75).^2);
      DY32(k) = sqrt((yy(m)-50.25).^2+(zz(j)-4.75).^2);
      DY42(k) = sqrt((yy(m)-49.75).^2+(zz(j)-5.25).^2);
      DY52(k) = sqrt((yy(m)-50.25).^2+(zz(j)-5.25).^2);
...
%25mm zero degrees
      ...
      DY24(k) = sqrt((yy(m)-49.75).^2+(zz(j)-24.75).^2);
      DY34(k) = sqrt((yy(m)-50.25).^2+(zz(j)-24.75).^2);
      DY44(k) = sqrt((yy(m)-49.75).^2+(zz(j)-25.25).^2);
      DY54(k) = sqrt((yy(m)-50.25).^2+(zz(j)-25.25).^2);




 EE(m,k,j)= min([DX(k),DY(k),DZ(k),DX1(k),DY1(k),DZ1(k),DX2(k),DX3(k),DX4(k),DX5(k),DX6(k),DX7(k),DX8(k),DX9(k),DX10(k),DX11(k),DX12(k),DX13(k),DY2(k),DY3(k),DY4(k),DY5(k),DX21(k),DX31(k),DX41(k),DX51(k),DX61(k),DX71(k),DX81(k),DX91(k),DX101(k),DX111(k),DX121(k),DX131(k),DY21(k),DY31(k),DY41(k),DY51(k),DX22(k),DX32(k),DX42(k),DX52(k),DX62(k),DX72(k),DX82(k),DX92(k),DX102(k),DX112(k),DX122(k),DX132(k),DY22(k),DY32(k),DY42(k),DY52(k),DX23(k),DX33(k),DX43(k),DX53(k),DX63(k),DX73(k),DX83(k),DX93(k),DX103(k),DX113(k),DX123(k),DX133(k),DY23(k),DY33(k),DY43(k),DY53(k),DX24(k),DX34(k),DX44(k),DX54(k), DX64(k),DX74(k),DX84(k),DX94(k),DX104(k),DX114(k),DX124(k),DX134(k),DY24(k),DY34(k),DY44(k),DY54(k)]); %Find the minimum distance of each points to 
